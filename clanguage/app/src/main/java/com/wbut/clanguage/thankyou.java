    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                sharingIntent.putExtra(android.content.Intent.EXTRA_SUBJECT, "I just scored " + score +" / 100 " + " in clanguage.");
                sharingIntent.putExtra(android.content.Intent.EXTRA_TEXT, "I just scored " + score +" / 100 " + " in clanguage. Thanks to http://mcatutorials.com");
 ...
 * */
    ...
    private void openBrowser1()
    {
        ...
        intent.putExtra("clickUrl", "http://mcatutorials.com/mca-tutorials-c-language.php");
